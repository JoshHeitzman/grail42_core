...
int faux_main()
{
    ...
    int gtest_result = G42CORE_TEST_GTEST_RUN_TESTS(G42CORE_TEST_NS detail::reporter_with_ostream(std::cout), 0, 0);
...
extern "C" JNIEXPORT jint JNICALL Java_grail42_core_bootstrap020_FauxConsole_main(JNIEnv * env, jobject  obj)
{
