...
echo   * The android_home environment variable must be set the root to the
echo     Android SDK.
...
echo For example:
echo.
echo set android_home=C:\adt-bundle-windows-x86\sdk
...
"%android_home%\platform-tools\adb.exe" shell am start -n %1/%2
...
"%android_home%\platform-tools\adb.exe" logcat -g | findstr /C:"0Kb consumed" > nul
if not ERRORLEVEL 1 goto LogHasEntries
...
"%android_home%\platform-tools\adb.exe" logcat -d -v raw 13380324612F4E3184624E7AD706141A:I *:S | findstr "4D85BA47C2364027A09FBF016A5C2C2A" > nul
...
if /i %iterations% GEQ 4 (
	...
	echo.
	if defined grail42_cmd_verbose_logging ("%android_home%\platform-tools\adb.exe" logcat -d) else ("%android_home%\platform-tools\adb.exe" logcat -d -v raw stderr:I stdout:I *:S)
...
"%android_home%\platform-tools\adb.exe" logcat -d -v raw 13380324612F4E3184624E7AD706141A:I *:S | findstr "ECD3B7A023654F9D99F2EF3D4AA33925" > nul
...
for /f "delims=" %%i in ('"%android_home%\platform-tools\adb.exe" logcat -d -v raw 13380324612F4E3184624E7AD706141A:I stderr:I stdout:I *:S') do (call "%grail42_core_cmd%\if_equ_set.cmd" %%i ECD3B7A023654F9D99F2EF3D4AA33925 enable_stdout_echo) && (if "!enable_stdout_echo!"=="1" echo %%i) && (call "%grail42_core_cmd%\if_equ_set.cmd" %%i 4D85BA47C2364027A09FBF016A5C2C2A enable_stdout_echo 1)
